...
public class Constants {
	...
	public static final String PAGE_HEADERTEXT="Your Store11";
	...
	public static final String REGISTERS_SHEET_NAME ="regis"; 
	public static final String PRODUCT_SHEET_META ="product"; 
}
